    ...
    return(
        <div className="border-b-[#E1E7EA] border-b-1 h-1/12 pr-60">
            <div className="flex h-full items-center w-full justify-end relative">
                ...
                {!query ? <IoIosSearch className="border-[#E1E7EA] border-1 rounded-l-none h-10 w-10 p-2 cursor-pointer rounded-xl"/> : <div onClick={resetQuery} className="border-[#E1E7EA] cursor-pointer border-1 text-xl flex items-center justify-center font-semibold rounded-l-none h-10 w-10 p-2 rounded-xl"> X </div> }
                <div className={`border-1 border-gray-200 z-100 bg-white absolute top-18 overflow-y-scroll ${query ? `max-h-200` : ``}`}>
